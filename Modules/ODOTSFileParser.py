...
class FileParserTCPWriter():
    ...
    def ReadTimeLine(self,LineFromFile):
        ...
        try:
            ...
            print(" >>>!!! INVALID DONLOADRECORD ATTEMPT")
            self.BlockTCPSocket = True # a crappy workaround - but means download block is process call agnostic
            return [[None,None],[None,None]]
    ...
    def SendToSocket(self, String=None):
        ...
        FinalString = "SendPunch.jar "+ String
        print(FinalString)
        Result = os.system(FinalString) #calls JAVA program that actually handles sending the info over a TCP link to MEoS
